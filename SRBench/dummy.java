...
public class CityBench_parallel {
    ...
    public static void main(String[] args) {
        try {
            ...
            // ここを確認
            CityBench_parallel cb = new CityBench_parallel(prop, parameters);
            cb.startTest();
     ...
     * @throws Exception
     */
    public CityBench_parallel(Properties prop, HashMap<String, String> parameters) throws Exception {
        //仕事を指せる対象のGridサーバのリスト
    ...
    //public void GridTest(InetSocketAddress address) {

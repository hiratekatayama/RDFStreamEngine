...
public class BDBGraphPatternRouter extends OpRouterBase {
	 ...
	 *@param ds
	 */
	public BDBGraphPatternRouter(ExecContext context, Op op, org.apache.jena.sparql.core.DatasetGraph ds) {
		super(context, op);
		//this.op=op;
	...
	private void init(org.apache.jena.sparql.core.DatasetGraph ds) {
